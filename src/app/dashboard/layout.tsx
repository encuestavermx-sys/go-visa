...
export default function DashboardLayout({
    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-sm font-semibold text-on-surface-variant">Cargando tu panel de Go-Visa...</span>
        </div>
      </div>
    );
  }
  ...
  const menuItems = [
    { name: "Resumen", path: "/dashboard", icon: "dashboard" },
    { name: "Formulario DS-160", path: "/dashboard/ds160", icon: "edit_document" },
    { name: "Documentos", path: "/dashboard/documents", icon: "folder_open" },
    { name: "Soporte y Mensajes", path: "/dashboard/messages", icon: "forum" },
  ];

  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0b1c30] flex relative">
      {/* Sidebar - Desktop */}
        ...
        <div className="border-t border-slate-100 pt-4 mt-auto">
          <div className="flex items-center gap-3 px-3 py-2 bg-slate-50 border border-slate-150 rounded-xl mb-3">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-xs font-semibold text-slate-800 truncate">{currentUser?.displayName}</span>
